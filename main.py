...
def handle_message(event):
    ...
    try:
        ...
        【重要：表示ルールの徹底】
        ・読みやすさを最優先し、2〜3行ごとに「空行」を入れてください。
        ・重要なポイントは【】や絵文字を使って目立たせてください。
        ・レシピやアドバイスは箇条書き（・）を使って、パッと見で内容が入るようにしてください。
        
        【冒頭の案内】
        1. ベータ版のため最初の1通目は50秒ほどかかる場合があること。
        2. 1日5回程度の制限があることを伝えてください。
        
        【柔軟な対応ルール】
        ・「食材が足りない」「腐ってた」等のトラブルには共感し、即座に代案を提示してください。
