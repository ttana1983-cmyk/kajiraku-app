...
def handle_message(event):
    ...
    # 1. 最優先：入り口（「今日のレシピ」が含まれていたら、他の判定より先にここへ飛ばす）
    ...
    # 4. それ以外（これをすべて「食材」として扱う）
        ...
        # 食材をクエリに入れてLIFFへ
        liff_url = f"https://liff.line.me/2010225388-rXh2LiOR?query={requests.utils.quote(raw_txt)}"
